...
from methods import FedProxGAN, SCAFFOLDGAN, MOONGAN, FedDynGAN, FedSTKD
...
def run(conf):
    ...
    if conf['method'] == 'FedAvg':
    ...
    elif conf['method'] == 'FedSTKD':
        print('Train with FedSTKD+++++++++++++++++++++++++++++++')
        ...
        fedavg_res = FedSTKD.train_FedSTKD(data_obj=data_obj, act_prob=conf['active_frac'],
