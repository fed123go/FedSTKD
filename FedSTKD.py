...
def train_FedSTKD(data_obj, act_prob, learning_rate, batch_size, epoch,
    ...
    suffix = 'FedSTKD_' + suffix
    return train_FedG_common(data_obj=data_obj, act_prob=act_prob, learning_rate=learning_rate,
